...
<?	
	...
	$tel2=trim(substr($row[tel17],3,4));        // 3번 위치에서 4자리
	$tel3=trim(substr($row[tel17],7,4));   
	$phone1=trim(substr($row[tel17],0,3));        // 0번 위치에서 3자리 문자열 추출
	$phone2=trim(substr($row[tel17],3,4));        // 3번 위치에서 4자리
	$phone3=trim(substr($row[tel17],7,4)); 
	$birthday1=substr($row[birthday17],0,4);            
	$birthday2=substr($row[birthday17],5,2);
	$birthday3=substr($row[birthday17],8,2);
...
<!-------------------------------------------------------------------------------------------->	
			...
			<table border="0" cellpadding="0" cellspacing="0" width="747" align="center">
				...
				<tr>
					<td height="30" align="center">
						<p><img src="images/member_join.jpg" width="256" height="46" border="0"></p>
					</td>
				</tr>
				<tr><td height="13"></td></tr>
			</table>

			<table border="0" cellpadding="0" cellspacing="0" width="685" class="cmfont" align="center">
				<tr>
			...
			<table border="0" cellpadding="5" cellspacing="1" width="685" bgcolor="cccccc" align="center">
								...
								<td align="center">
									...
									<table border="0" cellpadding="0" cellspacing="0" width="635" class="cmfont">
										<tr>
											...
											<td>
												<?echo("<input type='text' name='name' maxlength='10' value='$row[name17]' size='20' class='cmfont1'>")?>
											</td>
										</tr>
										<tr>
											<td width="127" height="30">
											...
											<td>
												<?echo("<input type='text' name='birthday1' size='4' maxlength='4' value='$birthday1' class='cmfont1'><font color='898989'>년</font> 
												...
												else echo("<input type='radio' name='sm' value='0'><font color='898989'>양력</font>
									...
									<table border="0" cellpadding="0" cellspacing="0" width="635" class="cmfont">
										...
										<tr>
											...
											<td>
												<? echo("<input type='text' name='phone1' size='4' maxlength='4' value='$phone1'  class='cmfont1'><font color='898989'>-</font>
										...
										<tr>
											...
											<td>
												<?echo("<input type='text' name='zip' size = '5' maxlength = '5' value = '$row[zip17]' class='cmfont1'>");?>
												<a href="javascript:FindZip(0)"><img align="absmiddle" src="images/b_zip.gif" border="0"></a><br>
												<? echo("<input type='text' name='juso' size = '50' maxlength = '200' value = '$row[juso17]' class='cmfont1'>");?><br>
											</td>
										</tr>
										<tr>
											<td width="127" height="50">
											...
											<td>
												<? echo("<input type='text' name='email' size='50' maxlength='50' value='$row[email17]' class='cmfont1'>"); ?>
											</td>
										</tr>
										<tr><td colspan="2" height="10"></td></tr>
										<tr><td colspan="2" bgcolor="E6DDD5"></td></tr>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="590" class="cmfont" align="left">
				<tr>
					<td height="45" align="right">
						<a href="javascript:Check_Value();"><img src="images/e_edit.gif" border="0"></a> &nbsp;&nbsp
