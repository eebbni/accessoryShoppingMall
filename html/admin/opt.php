...
<?
	include "../common.php";
	$query="select * from opt order by name17;";
...
<table width="500" border="1" cellpadding="2"  style="border-collapse:collapse">
  ...
  echo("<tr bgcolor='#F2F2F2' height='20'>	
	<td width='50'  align='center'>$row[no17]</td>
	<td width='250' align='left'>$row[name17]</td>
	<td width='100' align='center'>
	<a href='opt_edit.php?no1=$row[no17]'>수정</a>/
	<a href='opt_delete.php?no1=$row[no17]' onclick='javascript:return confirm(\"삭제할까요 ?\");'>삭제</a>
	</td>
	<td width='100' align='center'><a href='opts.php?no1=$row[no17]'>소옵션편집</a></td>
	</tr>
	</tr> ");
	}?>
</table>
