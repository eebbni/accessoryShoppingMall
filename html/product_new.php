								...
								<td align="center" valign="middle">
									<table border="0" cellpadding="0" cellspacing="0" width="730" height="40" class="cmfont">
										<tr>
											...
											<font color='#C83762' class='cmfont'><b>NEW&nbsp</b></font>
											</td>
...
<?
	...
	{
		$tmp =$page_s;
		echo("<a href='product_new.php?page=$tmp&text1=$text1'>
	...
	for($i=$page_s+1; $i<=$page_e; $i++)
	{
		if($page == $i)
			...
			echo("<a href='product_new.php?page=$i&text1=$text1'>[$i]</a>&nbsp");
	}
	if ($block < $blocks)
	{
		$tmp = $page_e+1;
		echo("&nbsp<a href='product_new.php?page=$tmp&text1=$text1'>
