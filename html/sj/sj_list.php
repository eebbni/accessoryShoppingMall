...
<table width="400" border="1" cellpadding="2" style="border-collapse:collapse">
  ...
  <? 
  if(!$text1)
	$query="select * from sj order by name17;";
  else
	$query="select * from sj where name17 like '%$text1%' order by name17;";
...
for($i=0; $i<$page_last; $i++)
 ...
 echo("<tr bgcolor='lightyellow'>
	...
	<a href='sj_edit.php?no=$row[no17]'>$row[name17]</a></td>
    <td align='center'>&nbsp $row[kor17]</td>
    <td align='center'>&nbsp $row[eng17]</td>
    <td align='center'>&nbsp $row[mat17]</td>
    <td align='center'>&nbsp $row[hap17]</td>
	<td align='right'>$avg &nbsp</td>
  <td align='center'>
		<a href='sj_delete.php?no=$row[no17]'
