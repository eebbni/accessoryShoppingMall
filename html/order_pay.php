...
<?
               ...
               if($row[icon_sale17]==1){
				...
				<tr>
					<td colspan="5" bgcolor="#F0F0F0">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="cmfont" align="center">
							<tr>
			...
			<table width="710" border="0" cellpadding="0" cellspacing="0" class="cmfont" align="center">
				<tr>
					...
					<td align="center" width="560">
						...
						<table width="560" border="0" cellpadding="0" cellspacing="0" class="cmfont" align="center">
							<tr height="25">
			...
			<table width="900" border="0" cellpadding="0" cellspacing="0" class="cmfont">
				<tr>
					<td align="center">
